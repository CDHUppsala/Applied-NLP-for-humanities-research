...
The repository contains scripts to lemmatize Swedish texts using pefselab (see folder Lemmatization with Efselab) as well as scripts for analyzing literary style (see folder Literary Style).
